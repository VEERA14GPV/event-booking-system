...
public class EventController {
     ...
     *
     * Backed by Elasticsearch (name, description,
     * category, venue). Falls back to a MySQL LIKE
     * query (via Resilience4j) if Elasticsearch is
     * unavailable - see EventSearchService.
     */
    @GetMapping("/search")
    public ResponseEntity<Page<EventResponse>>
    searchEvents(
