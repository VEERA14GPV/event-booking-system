...
public class AuthService {
     ...
     *
     * Used for validating username/password.
     */
     ...
     * for hashing passwords before storing.
     */
    private final PasswordEncoder passwordEncoder;

    /*
     * Repository for role lookup.
     */
    ...
    public String register(RegisterRequest request) {
         ...
         * Password encryption.
         *
         * Raw passwords should NEVER
         * be stored directly in database.
         */
        user.setPassword(
